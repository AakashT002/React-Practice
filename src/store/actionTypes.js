...
export const ADD_BLANK_USER_REQUEST = 'ADD_BLANK_USER_REQUEST';
export const ADD_BLANK_USER_SUCCESS = 'ADD_BLANK_USER_SUCCESS';
export const ADD_BLANK_USER_FAILURE = 'ADD_BLANK_USER_FAILURE';

export const UPDATE_USER_REQUEST = 'UPDATE_USER_REQUEST';
export const UPDATE_USER_SUCCESS = 'UPDATE_USER_SUCCESS';
export const UPDATE_USER_FAILURE = 'UPDATE_USER_FAILURE';

export const STOP_CLIENT_SPINNER = 'STOP_CLIENT_SPINNER';
export const STOP_ROLE_SPINNER = 'STOP_ROLE_SPINNER';
